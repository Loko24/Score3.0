...
namespace SCORM1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult SendEmail(FormViewModel model)
        {
            ...
            {
                string id = "246c0daa-e09a-487e-ae3e-f895df8ee86a";
                ...
                if (enroll.Count!=0)
                {
                    foreach (var item in enroll)
                    {
                        ...
                        solicitudes.Subject = "Contácto tutor";
                        solicitudes.Body = "Cordial saludo " + "<br/>" +
                           ...
                           "<br/>" +
                           "<br/>" + "Equipo de Soporte GASTRONOMIA";
        ...
        {
            MailMessage solicitud = new MailMessage();
            solicitud.Subject = "Petición de restauración de datos de compañia " + company;
            solicitud.Body = "Cordial saludo " + "<br/>" +
                "Sr(a). " + NameUser + "<br/>" +
               "<br/>" + "Registramos en nuestro sistema que has perdido tus datos de acceso." +
               "<br/>" + "Por este motivo por favor accede al siguiente link " +
                "<br/>" + "https://www.aprendeyavanza2.com.co/SaludVida/"+
